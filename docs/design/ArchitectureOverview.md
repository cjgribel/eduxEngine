...
- Reusable runtime systems are provided for rendering, asset loading, skeletal animation, math utilities, logging, debug drawing, simple collision and picking, and ECS-oriented work through EnTT.
...
- Support input-driven logic, basic ECS-based scene work, and simple collision or picking.
...
- [1.1 Engine Context Object](#11-engine-context-object)
- [1.2 `IApp`: Application Host Boundary](#12-iapp-application-host-boundary)
- [1.3 `IGameRuntime`: Game Runtime Boundary](#13-igameruntime-game-runtime-boundary)
- [1.4 Shared Services vs World State](#14-shared-services-vs-world-state)
- [1.5 GUI Actions Layer](#15-gui-actions-layer)
- [1.6 Custom Asset Storage](#16-custom-asset-storage)
- [1.7 Edit / Play Modes](#17-edit--play-modes)
- [1.8 Threaded Execution](#18-threaded-execution)
- [1.9 Async Loading](#19-async-loading)
- [1.10 Events](#110-events)
- [1.11 GUIDs and Reference Binding](#111-guids-and-reference-binding)
- [1.12 Batch / Scene Partitioning](#112-batch--scene-partitioning)
- [1.13 Main-Thread Boundaries](#113-main-thread-boundaries)
- [1.14 Runtime Pipeline](#114-runtime-pipeline)
...
- [2.5 Scripting / Lua (planned)](#25-scripting--lua-planned)
...
### 1.2 `IApp`: Application Host Boundary
...
### 1.3 `IGameRuntime`: Game Runtime Boundary
...
- Library / note: Custom repo design decision rather than a library feature.
- Pattern: Separation of concerns, with composition rather than inheritance.

### 1.5 GUI Actions Layer
...
### 1.11 GUIDs and Reference Binding
